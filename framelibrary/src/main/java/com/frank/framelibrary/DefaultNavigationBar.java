package com.frank.framelibrary;
...
import com.frank.baselibrary.widgets.navigationbar.AbsNavigationBar;

/**
 * Created by Frank on 2018/9/14.
 *
 * @fuction 默认布局的NavigationBar
 */
public class DefaultNavigationBar<D extends
    ...
    @Override
    public int bindLayoutId() {//设置默认布局
